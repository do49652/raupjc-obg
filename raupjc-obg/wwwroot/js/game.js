...
var start = function () {
    ...
    window.ws = new wsImpl("ws://13.58.58.66:8181");
        ...
        if (message == "ready") {
            ...
            $(function () {
                ...
                for (let i = 0; i < game["Players"][username]["Items"].length; i++)
                    log += '<button class="btn btn-default" data-toggle="tooltip" title="' + game["Players"][username]["Items"][i]["Description"] + '" id="item' + (i + 1) + '">' + game["Players"][username]["Items"][i]["Name"] + "</button>";
